...
// Server lists the play service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Add    http.Handler
	Rate   http.Handler
...
// New instantiates HTTP handlers for all the play service endpoints using the
...
func (s *Server) Service() string { return "play" }
...
// Mount configures the mux to serve the play endpoints.
func Mount(mux goahttp.Muxer, h *Server) {
	MountAddHandler(mux, h.Add)
	MountRateHandler(mux, h.Rate)
}

// MountAddHandler configures the mux to serve the "play" service "add"
// endpoint.
...
func NewAddHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "play")
...
// MountRateHandler configures the mux to serve the "play" service "rate"
// endpoint.
